...
def nginx_http_front_server(
    ...
    *,
    ...
    return "\n".join([
        ...
        "        auth_request_set $sf_node_auth_timing $upstream_http_server_timing;",
        ...
        "        add_header Server-Timing $sf_node_auth_timing always;",
        "    }",
        ...
        "        # STREAMFORGE_NODE_DIRECT_MEDIA_SENDFILE_NO_AIO_V1233:",
        "        # HLS segments are local immutable files. sendfile avoids one 32-thread",
        "        # AIO pool per worker (40 workers previously created about 1,280 threads).",
        "        sendfile on;",
        "        tcp_nopush on;",
