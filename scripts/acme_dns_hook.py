...
ACCOUNT_FILE = Path(os.getenv("STREAMFORGE_ACME_DNS_ACCOUNT_FILE", "/var/lib/streamforge/acme-dns/accounts.json"))
...
def main() -> int:
    ...
    try:
        ...
        print(f"StreamForge DNS-01 hook failed: {exc}", file=sys.stderr)
        return 1
